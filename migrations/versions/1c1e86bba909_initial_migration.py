...
Revision ID: 1c1e86bba909
Revises: 
Create Date: 2024-07-16 23:27:10.801865
...
def upgrade():
    ...
    sa.Column('sis_course_id', sa.String(), nullable=True),
    ...
    sa.PrimaryKeyConstraint('course_id', 'user_id', 'section_id')
    )
